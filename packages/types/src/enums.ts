 ...
 *                     \-> CANCELLED
 * PUBLISHED | ENTRY_HIT | T1_HIT | T2_HIT -> EXITED (emergency exit, can happen from any live state)
 * PUBLISHED | ENTRY_HIT -> EXPIRED (time-based, no entry)
 *
 * Terminal states: CANCELLED, EXPIRED, EXITED, CLOSED (T3_HIT reached and closed).
 */
...
export const NotificationPriority = {
  NORMAL: 'NORMAL',
  CRITICAL: 'CRITICAL', // EXIT NOW — dedicated high-priority queue
} as const;
